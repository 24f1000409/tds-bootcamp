...
--- Before Day-1 ---
I already knew basic computer usage, internet browsing, and had some familiarity with programming concepts.
---
...
- Using basic terminal commands like mkdir, touch, ls, cd
- Understanding file paths in Linux
- Connecting VS Code to WSL
- Creating a GitHub repository and committing files
---

--- Feedback (Suggestions for the TDS Team) ---
The content was clear and well-organized. It would be helpful to have more practice exercises for terminal commands.
---
