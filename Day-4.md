...
--- Before Day-4 ---
I already knew basic Python scripting and had some understanding of how the web works.
---
...
- How HTTP methods and status codes work in real APIs
- How to inspect network requests using Chrome DevTools
- How to use curl for making API requests from terminal
- How FastAPI auto-generates Swagger documentation
- How to build and test REST API endpoints
---

--- Feedback (Suggestions for the TDS Team) ---
The FastAPI section was very hands-on and practical. More examples on error handling in APIs would be great.
---
