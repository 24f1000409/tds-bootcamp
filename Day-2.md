...
--- Before Day-2 ---
I already knew basic terminal commands from Day-1 and had some understanding of file navigation in Linux.
---
...
- How PATH works and how the shell finds commands
- Using grep to search inside files
- Chaining commands together using pipes
- How environment variables work in Linux
- Editing files directly in the terminal using nano
---

--- Feedback (Suggestions for the TDS Team) ---
The session was very informative. Real-world examples of pipes and redirection would make it even better.
---
